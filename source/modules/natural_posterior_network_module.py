...
class NaturalPosteriorNetworkLightningModule(BaseLightningModule):
    ...
    def setup_model(self):
        model_class = get_model_class('natural_posterior_network')
        self.model = model_class(self.config.num_node_features, self.config.num_classes, self.config.model_config)
...
class NaturalPosteriorFlowLightningModule(BaseLightningModule):
    def __init__(self, module_config):
        super().__init__(module_config)
        self.config = module_config
