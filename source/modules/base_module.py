...
from source.metrics import create_metrics_per_problem_name, create_misclassification_targets, create_ood_targets, prepare_masks_per_step, reduce_masks
...
class BaseLightningModule(pl.LightningModule):
    ...
    def track_loss(self, batch, outputs):
        ...
        labels, masks, step_name = batch[-3:]
