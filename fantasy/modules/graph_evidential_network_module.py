...
from fantasy.layers.loss import DirichletBayesianLoss


UNCERTAINTY_ESTIMATE_NAMES = ['data', 'knowledge', 'total']


class GraphEvidentialNetworkLightningModule(BaseLightningModule):
    ...
    def setup_model(self):
        model_class = get_model_class('graph_evidential_network')
