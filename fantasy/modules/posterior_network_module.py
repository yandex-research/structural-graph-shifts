...
class PosteriorNetworkLightningModule(BaseLightningModule):
    ...
    def setup_model(self):
        model_class = get_model_class('posterior_network')
...
class PosteriorFlowLightningModule(BaseLightningModule):
    def __init__(self, module_config):
        super().__init__(module_config)
        self.config = module_config
