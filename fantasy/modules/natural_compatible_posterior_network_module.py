...
class NaturalCompatiblePosteriorNetworkLightningModule(BaseLightningModule):
    ...
    def setup_model(self):
        model_class = get_model_class('natural_compatible_posterior_network')
    ...
    def on_train_start(self):
        ...
        self.model.init_probas_propagation(compatible_propagation_estimate)
...
class NaturalCompatiblePosteriorPredictorLightningModule(BaseLightningModule):
    def __init__(self, module_config):
        super().__init__(module_config)
        self.config = module_config
...
class NaturalCompatiblePosteriorFlowLightningModule(BaseLightningModule):
    def __init__(self, module_config):
        super().__init__(module_config)
        self.config = module_config
